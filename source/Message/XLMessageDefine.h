...
// [case] 帐号消息
#define XLM_USER_LOGIN							0x02010000UL		// 帐号登录
#define XLM_USER_SWITCH							0x02030000UL		// 帐号切换
#define XLM_USER_EXIT							0x02040000UL		// 帐号退出


// [case] 窗口消息
#define XLM_WINDOW_SWITCH_LEVEL_1					0x03010000UL		// 窗口切换:级别1
